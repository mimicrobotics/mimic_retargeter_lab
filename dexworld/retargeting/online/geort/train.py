"""DexWorld-side training entrypoint for GeoRT with the MJCF backend.
...
yaml at `config/retargeter_cfg/geort/human_hand_to_<hand>.yaml`) to assemble:
  - to_model        : RobotHandModel built from the dexworld MJCF
...
from dexworld.hand_models import HumanHandModel, create_robot_hand
from dexworld.retargeting.online.geort import MjcfGeoRTTrainer
