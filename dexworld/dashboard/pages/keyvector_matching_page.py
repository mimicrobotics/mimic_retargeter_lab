...
:func:`dexworld.types.metrics.kv_metrics` — direction-and-scale-invariant
...
from dexworld.types.metrics import kv_metrics
...
class KeyvectorMatchingPage:
    ...
    # :func:`dexworld.types.metrics.kv_metrics` — one ``MetricSpec``
    ...
    def _build_vector_card(self, ep_data: Dict[str, Any], vec_name: str) -> html.Div:
        ...
        :func:`dexworld.types.metrics.kv_metrics` — the registry is
