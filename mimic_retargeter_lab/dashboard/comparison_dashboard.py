...
from mimic_retargeter_lab.types.metrics import (
    METRICS,
    BenchmarkMetric,
    Direction,
    MetricSpec,
...
def _extract_keyvector(data: Dict[str, Any]) -> Dict[str, Dict[str, float]]:
    ...
    Driven by :func:`mimic_retargeter_lab.types.metrics.kv_metrics`; the (subkey, stat)
...
class ComparisonDashboard:
    ...
    # :data:`mimic_retargeter_lab.types.metrics.METRICS` (anything with
    ...
    def _per_hand_headline(self, hand_data: Dict[str, Any]) -> Dict[str, float | str]:
        ...
        :data:`mimic_retargeter_lab.types.metrics.METRICS`. ``np.nan`` indicates the
